package com.netcore.cleanwave.platform.profiles.infrastructure.persistence.jpa.embeddables;
...
public class StreetAddressPersistenceEmbeddable {
    ...
    @Column(name = "strett_address_city")
    private String city;

    @Column(name = "strett_address_postla_code")
    private String postalCode;

    @Column(name = "strett_address_country")
